<header class="navbar navbar-expand fixed-top flex-column flex-md-row bd-navbar">
    <a class="navbar-brand ml-5 mr-0 mr-md-3" href="{{route('home')}}">
    ...
    @guest
        ...
        <li class="nav-item ">
            <a class="nav-item mr-md-5" href="#" id="">
                <button type="button" class="btn btn-secondary"> EN <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-globe" viewBox="0 0 16 16">
